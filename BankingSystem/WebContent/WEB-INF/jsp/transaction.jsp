...
<tr >
    ...
    <td width="1200" valign="top">
    	<div id="welcome" style="border-right:#666666 1px dotted;"><h1>TRANSACTION HISTORY</h1><br>
		...
		<tr>
			...
			out.print(request.getAttribute("balance"));
			 ...
			 --%></div>
				<form name=F1 onSubmit="return dil(this)" action="/BankingSystem/transaction1" method="post" >

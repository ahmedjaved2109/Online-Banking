    ...
    <td width="1200" valign="top">
		...
		<tr>
			...
			out.print(request.getAttribute("balance"));
			 ...
			 --%></div>
				<form name=F1 onSubmit="return dil(this)" action="/BankingSystem/transfer1" method="post" >
				   <table cellspacing="5" cellpadding="3">	<pre>
				  <tr><td>SENDER'S ACCOUNT NO:  </td><td> <input type="text" name="accountno"/></td></tr>
				  <tr><td>AMOUNT:               </td><td> <input type="text" name="amount"/></td></tr>
				  <tr><td>RECEIVER'S ACCOUNT NO:</td><td> <input type="text" name="accountno1"/></td></tr>
					<tr><td></td><td><input type="submit" value="Submit"/>
                   
                   <INPUT TYPE=RESET VALUE="CLEAR"></td></tr></pre>
             	</table>
				</form>
			</td>
		</tr>

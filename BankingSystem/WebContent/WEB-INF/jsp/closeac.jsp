...
<tr >
    ...
    <td width="1200" valign="top">
    	<div id="welcome" style="border-right:#666666 1px dotted;"><h1>ACCOUNT CLOSING FORM</h1><br>
		...
		<tr>
			...
			out.print(request.getAttribute("balance"));
			 ...
			 --%></div>
				<form name=F1 onSubmit="return dil(this)" action="/BankingSystem/closeac1" method="post" >
